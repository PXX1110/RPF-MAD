...
from configs.experiment_config import CRITERTION, get_model, get_dataset_train, get_dataset_train_without_class, load_SSL_model
...
if __name__ == "__main__":
    ...
    log_file_path = os.path.join(log_dir, "{}_Meta_Multi_AT_train_0.01_0.005_SGD_with_cl_outer.txt".format(opt.dataset))
    ...
    if opt.labelsmooth:
        criterion_L = LabelSmoothingLoss(smoothing=opt.labelsmoothvalue)
    ...
    for epoch in range(1, opt.num_epoch + 1):
        ...
        train_loss_avg, train_acc_avg, opt_e, opt_f, network, encoder = ModelTrainer.train_ssl_contra(epoch, dloader_train, network, encoder,
