...
if __name__ == "__main__":
    ...
    log_file_path = os.path.join(log_dir, "{}_Meta_Multi_AT_train_0.01_0.001_SGD_{}_wio_TRADES.txt".format(opt.dataset, opt.victim))
    ...
    for epoch in range(1, opt.num_epoch + 1):
        ...
        train_loss_avg, train_acc_avg, opt_e, opt_f, network = ModelTrainer.train_ssl_multi(epoch ,dloader_train, network,
