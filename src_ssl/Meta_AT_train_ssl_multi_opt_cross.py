...
if __name__ == "__main__":
    ...
    parser.add_argument('--lr_maxe', default=0.0001, type=float)
    parser.add_argument('--lr_maxf', default=0.0001, type=float)
    ...
    parser.add_argument('--victim', default='DeACL', choices=['simclr', 'byol', 'dino', 'mocov3', 'mocov2plus',
                                 'nnclr', 'ressl', 'swav', 'vibcreg', 'wmse', 'deepclusterv2', 'robust_ACL',  'ACL', 'AdvCL', 'AInfoNCE', 'DeACL',
    ...
    log_file_path = os.path.join(log_dir, "{}_Meta_Multi_AT_train_0.0001_0.0001_SGD_cross_{}.txt".format(opt.dataset, opt.victim))
    ...
    for epoch in range(1, opt.num_epoch + 1):
        ...
        train_loss_avg, train_acc_avg, opt_e, opt_f, network = ModelTrainer.train_ssl_multi_cross(epoch ,dloader_train, network,
        ...
        if (epoch) % opt.save_epoch == 0 or epoch >= 5:
            print("Waiting Test!")
            val_loss_avg, val_acc_avg = ModelTrainer.valid_ssl_multi_cross(epoch, dloader_val, network, criterion, opt_e, opt_f,
