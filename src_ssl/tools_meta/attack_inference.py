...
if __name__ == "__main__":
    ...
    parser.add_argument('--attack', type=int, default=[True,False],    # True, False
                            help='used attacks')
    parser.add_argument('--model', type=str, default=r'/home/users/pxx/workplace/5Adversarial/4Meta_AT_ResNet/results_ssl/CIFAR_10_Meta_Multi_AT_train_0.01_0.001_SGD_DynACL++_84_30/best_checkpint.pkl')
