...
if __name__ == "__main__":
    ...
    parser.add_argument('--model', type=str, default=r'/home/users/pxx/workplace/5Adversarial/9_2Robust_SSL/RobustSSL_Benchmark-main/checkpoints/SSL_cifar10_r18_gtsrb_meta/SLF/SLF_model_bestAT.pt')
    # Group 2
    ...
    ax.set_title(f"3D t-SNE Visualization of {args.load}_{args.mode} Embeddings for {args.dataset}")
    plt.savefig(f"tsne_3d_visualization_meta_10_lr_max_0.01_0.001_{args.pre_dataset}_{args.dataset}_{args.load}.png")
    plt.show()
