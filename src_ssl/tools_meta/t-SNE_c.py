...
if __name__ == "__main__":
    ...
    parser.add_argument('--model', type=str, default=r'results_ssl/01-21_17-35/best_checkpint.pkl')
    # Group 2
    ...
    parser.add_argument('--victim', default='DynACL++', choices=['simclr', 'byol', 'dino', 'mocov3', 'mocov2plus',
