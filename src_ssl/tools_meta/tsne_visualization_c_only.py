...
MODEL_CONFIGS_Meta_ACL = [
    {   # ACL 配置
        "name": "ACL",
        "model_path": r"/home/users/pxx/workplace/5Adversarial/4Meta_AT_ResNet/results_ssl/CIFAR_10_Meta_Multi_AT_train_0.01_0.001_SGD_ACL_82_28/best_checkpint.pkl",
        "load_type": "Meta_ACL",
        "victim": "Meta_ACL"
    },
    {   # AdvCL 配置
...
if __name__ == "__main__":
    ...
    PLOT_SAVE_PATH_EPS = os.path.join("result_tsne", f"comparative_tsne_CIFAR_10_{args.load}.eps")
    PLOT_SAVE_PATH_PNG = os.path.join("result_tsne", f"comparative_tsne_CIFAR_10_{args.load}.png")
