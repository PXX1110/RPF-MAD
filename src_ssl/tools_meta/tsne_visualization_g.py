...
# 常量定义
NUM_CLASSES = 10
TXT_SAVE_PATH = os.path.join("result_tsne", "gtsrb_variance_results.txt")
PLOT_SAVE_PATH = os.path.join("result_tsne", f"comparative_tsne_gtsrb.png")
...
if __name__ == "__main__":
    ...
    parser.add_argument('--data', type=str, default=r'/home/users/pxx/workplace/Datasets/GTSRB/test')
    ...
    # 获取数据加载器
    train_loader, val_loader, _, num_classes, args = get_loader(args)
    device = torch.device("cuda" if torch.cuda.is_available() else "cpu")

    # 创建可视化画布
    fig, axs = plt.subplots(4, 2, figsize=(20, 20))
    fig.suptitle("Comparative t-SNE Visualization (gtsrb)", fontsize=16)
